            ...
            <div class="contact-wrap d-flex align-items-center row">
                <div class="col-md-6 padding-15">
                    <div class="contact-info">
                        ...
                        <p>Si tienes preguntas sobre nuestros servicios de reportes ciudadanos, geolocalización, trámites o análisis de datos, o si estás interesado en colaborar con nosotros, no dudes en ponerte en contacto con nuestro equipo.</p>
                        <h3>Calz. Santo Tomás 110, Santo Tomas, Azcapotzalco, 02020 Ciudad de México, CDMX</h3>
                        <h4>
                            <span>Email:</span> contacto@radarciudadano.mx <br>
