...
<a href="{{ $dashboard_url }}"
    ...
    {{-- Small brand logo (Logo cuando sidebar está colapsado) --}}
    <img src="{{ asset('frontend/images/logo_.png') }}"
         alt="{{ config('adminlte.logo_img_alt', 'AdminLTE') }}"
         class="brand-image-xs logo-xs d-none"
         style="border-radius: 5px;">

    {{-- Large brand logo (Logo cuando sidebar está expandido) --}}
