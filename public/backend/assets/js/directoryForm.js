// public/backend/assets/js/directoryForm.js
...
$(document).ready(function() {
    ...
    $('form').submit(function(e) {
        ...
        if (!validateRequired(web, 'Sitio Web') || (web && !validateWeb(web))) {
