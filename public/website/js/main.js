...
(function ($) {
    ...
    $(window).on('load', function () {
        // Espera 1.5 segundos antes de añadir la clase 'loaded' al body.
        setTimeout(function () {
    ...
    $('#scroll-to-top').on('click', function (e) {
        ...
        $('html, body').animate({
            scrollTop: 0 // Desliza la página hacia el tope.
        }, 700); // Ajusta la duración del deslizamiento a 700 milisegundos. Puedes cambiar este valor a tu gusto.
    });
